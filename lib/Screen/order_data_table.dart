...
//               Row(
//                 children: [
// Icon(Icons.arrow_circle_down_sharp,color: ,)
//               ],)
              ...
              child: SingleChildScrollView(
                child: DataTable(
                  ...
                  rows: widget.orders.map(
                    (order) {
                      return DataRow(
                        color: order.type == true
                            ? MaterialStateProperty.all(
                                Colors.green.withOpacity(.5))
                            : MaterialStateProperty.all(
                                Colors.red.withOpacity(.5)),
                        // .green.withOpacity(.5) : Colors.red.withOpacity(.5),
                        cells: [
                          DataCell(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            child: Text(
                                              "${order.tag.target!.tag}",
                                              style: TextStyle(fontSize: 30),
                                            ),
                                          ),
                                          Column(
                                            children:
                                                order.tag.target!.orders.map(
                                              (_) {
                                                print(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      IconButton(
                                                                          ...
                                                                          icon: Icon(
                                                                              ...
                                                                              color: type == false ? Colors.lightBlueAccent : Colors.white60)),
